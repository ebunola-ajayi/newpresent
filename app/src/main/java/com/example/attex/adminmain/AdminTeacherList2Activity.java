...
public class AdminTeacherList2Activity extends AppCompatActivity {

    RecyclerView recyclerView;
    AdminTeacherList2Adapter adapter;
    ArrayList<ModelTeacher> teacherList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_teacher_list2);
        ...
        adapter = new AdminTeacherList2Adapter(teacherList, this, schoolID, classGrade);
